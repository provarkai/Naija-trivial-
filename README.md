...
**Fact-check status:** all 400 questions have now been checked against live sources (Wikipedia, CAF, FIFA, Grammy.com, Billboard, the OED, major Nigerian outlets), across two passes. The first pass covered the highest-risk ~65 questions (every "hard"-difficulty one, plus specific-fact "medium" ones: award years, club affiliations, match results, attributions) and caught **five** real errors:

- A sports question misattributed Yamile Aldama (competed for Sudan, then Cuba, then Great Britain — never Nigeria, never won Olympic gold) as a Nigerian gold medalist; replaced with a verified Chioma Ajunwa fact.
- A naija_music question claimed Wizkid, Davido, *and* Wande Coal all passed through EME — Wande Coal was actually signed to Mo'Hits, and Davido was never on EME. Narrowed to just Wizkid, who did pass through EME.
- A naija_music question claimed D'Prince co-founded Mavin Records — he was an early artist there, not a co-founder (Don Jazzy founded it alone). Replaced with D'Prince founding his own label, Jonzing World.
- A sports question claimed Stephen Keshi was the first African to win AFCON as both player and coach — he was the *second*, after Egypt's Mahmoud El-Gohary. Rewritten around that actual fact.
- A sports question claimed Amuneke scored Nigeria's *opening* goal against Bulgaria at the 1994 World Cup — Yekini scored first, Amuneke scored third in that same match. Reworded to drop the false "opening" claim.

The second pass covered the remaining ~335 questions — general knowledge (geography, government, symbols, currency), the rest of Nigerian history, Nollywood, naija music, sports, and pidgin/proverbs — and found **one** more issue, softer than the first five: a pidgin_proverbs question asked what country Nigerian slang "Jand" refers to, answer "the United Kingdom." That's true as the term's origin (a clipping of "England"/"London"), but the OED's December 2024 entry documents that live 2020s usage has broadened to mean "abroad" generically, not the UK specifically — so the original phrasing risked being read as a current-usage claim rather than an etymological one. Reworded to ask about the term's *origin* specifically, which keeps the same verified answer honest.

No other errors turned up in this second pass. Every remaining question in every category — capital/states/currency/symbols, ECOWAS/OPEC, pre-colonial and 20th-century political history, Nollywood directors and box-office facts, music real names/labels/chart records, football/basketball/combat-sports records, and pidgin/proverb meanings — came back confirmed against primary or reputable secondary sources.
